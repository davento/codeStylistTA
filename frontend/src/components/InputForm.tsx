...
// Dynamically import MonacoEditor (client-side only)
...
export default function InputForm({
    ...
    // Map selected programming language to Monaco language id (defaulting to plaintext)
    return (
        <div className="w-full md:w-1/2 space-y-8">
            {/* Submit / Reset Buttons */}
            <div className="flex justify-between">
                <button onClick={resetAll} className="flex items-center gap-2 px-4 py-2 border border-red-500 text-red-500 rounded hover:bg-red-50 transition">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className={`mt-1 block w-full border ${
                                formErrors.language ? 'border-red-500 bg-red-50' : 'border-gray-300'
                            } rounded-md p-2`}
                        >
                        ...
                        {formErrors.language && <p className="text-red-500 mt-1 text-sm">{formErrors.language}</p>}
                    </div>
                    <div>
                        ...
                        <select
                            ...
                            className={`mt-1 block w-full border ${
                                formErrors.course ? 'border-red-500 bg-red-50' : 'border-gray-300'
                            } rounded-md p-2`}
                        >
                        ...
                        {formErrors.course && <p className="text-red-500 mt-1 text-sm">{formErrors.course}</p>}
                    </div>
                    <div>
                        ...
                        <select
                            ...
                            className={`mt-1 block w-full border ${
                                formErrors.tone ? 'border-red-500 bg-red-50' : 'border-gray-300'
                            } rounded-md p-2`}
                        >
                        ...
                        {formErrors.tone && <p className="text-red-500 mt-1 text-sm">{formErrors.tone}</p>}
                    </div>
                    <div>
                        ...
                        <select
                            ...
                            className={`mt-1 block w-full border ${
                                formErrors.format ? 'border-red-500 bg-red-50' : 'border-gray-300'
                            } rounded-md p-2`}
                        >
                        ...
                        {formErrors.format && <p className="text-red-500 mt-1 text-sm">{formErrors.format}</p>}
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow relative">
                <div className="flex justify-between items-center mb-2">
                    ...
                    <button onClick={clearCode} className="text-red-500 hover:text-red-700 text-sm">
                        Clear
                    </button>
                </div>
                <div className="border rounded-md overflow-hidden">
                    <MonacoEditor
                        width="100%"
                        height="300"
                        language={selectedProgLang?.monacoLanguage}
                        theme="vs-light"
                        value={code}
                        options={{
            ...
            <div className="bg-white p-6 rounded-lg shadow">
                ...
                <div className="flex flex-col gap-2">
                    <input
                        ...
                        accept={selectedProgLang?.extensions?.join(',') || '*/*'}
                    />
                    <button
                        onClick={() => fileInputRef.current?.click()}
                        className={`px-4 py-2 ${
                            formErrors.input && selectedFiles.length === 0 && !code
                    ...
                    {selectedFiles.length > 0 && (
                        <ul className="mt-2 space-y-1">
                            {selectedFiles.map((file, index) => (
                                <li key={index} className="flex items-center justify-between border p-2 rounded-md bg-gray-50">
