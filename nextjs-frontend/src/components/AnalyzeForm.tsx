...
export default function AnalyzeForm() {
    ...
    // Accept file types based on the selected programming language. Defaults to all.
    ...
    const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        // Validate file types based on accepted extensions.
    ...
    const uploadCode = () => {
        // For now, simply alert that the code has been updated.
        alert('Code updated.')
    }
    ...
    const analyze = async (codeToAnalyze: string, index: number) => {
        if (codeToAnalyze.trim() === '') {
            setErrorLog('No code uploaded as input. Please upload a file or enter code.')
        ...
        // Set loading state for this index to LOADING.
        setIsLoading((prev) => {
            const newState = [...prev]
    ...
    return (
        <div className="space-y-8">
            {/* Code/Text Input Section */}
            <div className="bg-white p-6 rounded-md shadow-md">
                <h1 className="text-2xl font-bold mb-4">Code Input</h1>
                <textarea
